...
const {createOrder, getAllOrders, updateOrder, changeOrderDeliveryStatus, getAllOrdersByUser} = require("../controller/order.js")
class ORDER_API {
    constructor() {
        this.router = router;
        this.setupRoutes();
    ...
    setupRoutes() {
        ...
        router.get('/get-all-user-orders', authMiddleware([ROLES]),  getAllOrdersByUser)
